...
namespace Wiley.Apartments.Web.Data.Migrations
{
    ...
    [Migration("20260827002800_AddFacilityReservationInventoryHeld")]
    partial class AddFacilityReservationInventoryHeld
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wiley.Apartments.Domain.FacilityRentalRate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("Space", "IsActive", "SortOrder");

                    b.ToTable("FacilityRentalRates", (string)null);
                });
            ...
            modelBuilder.Entity("Wiley.Apartments.Domain.FacilityReservationEquipment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("FacilityReservationId", "InventoryItemId")
                        .IsUnique();

                    b.ToTable("FacilityReservationEquipment", (string)null);
                });
            ...
            modelBuilder.Entity("Wiley.Apartments.Domain.FacilityReservationEquipment", b =>
                {
                    b.HasOne("Wiley.Apartments.Domain.FacilityReservation", null)
                        .WithMany("Equipment")
                        .HasForeignKey("FacilityReservationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Wiley.Apartments.Domain.FacilityInventoryItem", "InventoryItem")
                        .WithMany()
