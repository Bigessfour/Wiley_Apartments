...
**Status**: Phase 0 **complete** (T0.0–T0.7) — Phase 1 next ([tasks.md](specs/001-wiley-apartment-v1/tasks.md))
...
| `/speckit-implement`    | **Phase 0 done** — T1.1 units next ([tasks.md](specs/001-wiley-apartment-v1/tasks.md)) |
