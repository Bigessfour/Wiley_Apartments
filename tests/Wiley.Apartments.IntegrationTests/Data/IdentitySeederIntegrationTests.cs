...
public class IdentitySeederIntegrationTests : IClassFixture<ClerkSuiteWebApplicationFactory>
{
    private readonly ClerkSuiteWebApplicationFactory _factory;

    public IdentitySeederIntegrationTests(ClerkSuiteWebApplicationFactory factory)
    {
        _factory = factory;
    }
